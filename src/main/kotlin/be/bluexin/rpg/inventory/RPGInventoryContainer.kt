...
class RPGInventoryContainer(player: EntityPlayer, original: ContainerPlayer) : ContainerBase(player) {
    ...
    inner class RPGContainerImpl(private val vanillaSlots: ContainerPlayer) :
        ContainerImpl(this@RPGInventoryContainer) {
