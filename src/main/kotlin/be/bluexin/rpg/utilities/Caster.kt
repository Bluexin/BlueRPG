...
object CasterBlock : BlockModContainer("caster", Material.CLOTH) {
    override fun createTileEntity(world: World, state: IBlockState) = CasterTE()
...
class CasterTE : TileModInventoryTickable(1) {
