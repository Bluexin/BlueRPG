...
import be.bluexin.rpg.classes.ClassButton
import be.bluexin.rpg.classes.ClassesGui
import be.bluexin.rpg.classes.playerClass
import be.bluexin.rpg.devutil.ComponentEntity
...
class PlayerLayout(player: RPGInventoryContainer.InventoryWrapperPlayer) {
